package org.as3wavsound {
	...
	public class WavSoundChannel extends EventDispatcher {
		...
		internal function get wavSound():WavSound { return _wavSound }
		
		public function get leftPeak(): Number { return _leftPeak; }
 	 	public function get rightPeak(): Number { return _rightPeak; }
 	 	public function get position(): Number { return phase * _wavSound.length / _wavSound.samples.length; }
